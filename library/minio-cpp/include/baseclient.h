...
public:
    ...
    error::Error SetAppInfo(std::string_view app_name, std::string_view app_version);

    void HandleRedirectResponse(std::string& code,
                                std::string& message,
                                int status_code,
                                http::Method method,
                                ...
                                bool retry = false);
    Response GetErrorResponse(http::Response resp,
    ...
    DeleteBucketEncryptionResponse DeleteBucketEncryption(DeleteBucketEncryptionArgs args);
    DisableObjectLegalHoldResponse DisableObjectLegalHold(DisableObjectLegalHoldArgs args);
    DeleteBucketLifecycleResponse DeleteBucketLifecycle(DeleteBucketLifecycleArgs args);
    DeleteBucketNotificationResponse DeleteBucketNotification(DeleteBucketNotificationArgs args);
    DeleteBucketPolicyResponse DeleteBucketPolicy(DeleteBucketPolicyArgs args);
    DeleteBucketReplicationResponse DeleteBucketReplication(DeleteBucketReplicationArgs args);
    DeleteBucketTagsResponse DeleteBucketTags(DeleteBucketTagsArgs args);
    DeleteObjectLockConfigResponse DeleteObjectLockConfig(DeleteObjectLockConfigArgs args);
    DeleteObjectTagsResponse DeleteObjectTags(DeleteObjectTagsArgs args);
    EnableObjectLegalHoldResponse EnableObjectLegalHold(EnableObjectLegalHoldArgs args);
    ...
    GetBucketNotificationResponse GetBucketNotification(GetBucketNotificationArgs args);
    GetBucketPolicyResponse GetBucketPolicy(GetBucketPolicyArgs args);
    GetBucketReplicationResponse GetBucketReplication(GetBucketReplicationArgs args);
    ...
    GetPresignedObjectUrlResponse GetPresignedObjectUrl(GetPresignedObjectUrlArgs args);
    GetPresignedPostFormDataResponse GetPresignedPostFormData(PostPolicy policy);
    IsObjectLegalHoldEnabledResponse IsObjectLegalHoldEnabled(IsObjectLegalHoldEnabledArgs args);
    ListBucketsResponse ListBuckets(ListBucketsArgs args);
    ListBucketsResponse ListBuckets();
    ListenBucketNotificationResponse ListenBucketNotification(ListenBucketNotificationArgs args);
    ...
    SetBucketNotificationResponse SetBucketNotification(SetBucketNotificationArgs args);
    SetBucketPolicyResponse SetBucketPolicy(SetBucketPolicyArgs args);
    SetBucketReplicationResponse SetBucketReplication(SetBucketReplicationArgs args);
